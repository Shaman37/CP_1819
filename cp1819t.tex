...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{Tipo}\mathrel{=}\Conid{V}\mid \Conid{Vd}\mid \Conid{Ve}\mid \Conid{H}\mid \Conid{Ht}\mid \Conid{Hb}\;\mathbf{deriving}\;\Conid{Eq}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Varid{num}}{\Varid{bop}}\;\mathbf{where}\;\Varid{num}\;(\Varid{a})\mathrel{=}\Conid{Num}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\Varid{bop}\;(\Varid{b},(\Varid{c},\Varid{d}))\mathrel{=}\Conid{Bop}\;\Varid{c}\;\Varid{b}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Bop}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(\Varid{c},(\Varid{b},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{cataExpr}\mathbin{::}(\Conid{Int}+(\Conid{Op},(\Varid{d},\Varid{d}))\to \Varid{d})\to \Conid{Expr}\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{cataExpr}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recExpr}\;(\Varid{cataExpr}\;\Varid{g})\comp \Varid{outExpr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaExpr}\mathbin{::}(\Varid{a}\to \Conid{Int}+(\Conid{Op},(\Varid{a},\Varid{a})))\to \Varid{a}\to \Conid{Expr}{}\<[E]%
\\
...
\xymatrix@C=3cm{
    ...
    \ar@/^1pc/[r]^{\ensuremath{\Varid{outExpr}}}
    \ar@{}[r]|-{\cong}
&
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr}))} 
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{calcula}\times\Varid{calcula}))}}
    \ar@/^1pc/[l]^{\ensuremath{\Varid{inExpr}}}
\\
...
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{g}}\;\mathbf{where}\;\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{39}{}\<[39]%
\>[39]{}\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{*}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{39}{}\<[39]%
\>[39]{}\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 -\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{-}\Varid{b}{}\<[E]%
\ColumnHook
...
&
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr}))} 
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{show'}\times\Varid{show'}))}}
    \ar@/^1pc/[l]^{\ensuremath{\Varid{inExpr}}}
\\
     \ensuremath{\Conid{Int}} 
...
\par
Através desta representação, facilmente inferimos o nosso gene \emph{g} que para o caso de ser \emph{Int} o representa como uma \emph{String} (através da função auxiliar \emph{s_gen1}), e no caso de ser o tuplo composto por um operador \emph{Op} e outro tuplo de duas \emph{String}, temos apenas de representar a expressão consoante o operador \emph{Op} do tuplo (através da função auxiliar \emph{s_gen2}).
\par
...
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{s\char95 gen1}}{\Varid{s\char95 gen2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{s\char95 gen1}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{s\char95 gen1}\;\Varid{i}\mathrel{=}\Varid{show}\;\Varid{i}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s\char95 gen2}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{s\char95 gen2}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 ~+~\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[B]{}\Varid{s\char95 gen2}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 ~*~\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[B]{}\Varid{s\char95 gen2}\;(\Conid{Op}\;\text{\tt \char34 -\char34},(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 ~-~\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
...
\xymatrix@C=3cm{
    ...
    \ar[r]_-{\ensuremath{\p1\comp \Varid{head}\comp \Varid{readExp}}}
&
    \ensuremath{\Conid{Expr}} 
...
&
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr}))} 
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{compile}\times\Varid{compile}))}}
    \ar@/^1pc/[l]^{\ensuremath{\Varid{inExpr}}}
\\ 
   &  \ensuremath{\Conid{Int}} 
   & \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Código}\times\Conid{Código}))} 
      \ar[l]^-{g}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{f}}{\Varid{g}}\comp \p1\comp \Varid{head}\comp \Varid{readExp}\;\mathbf{where}\;\Varid{f}\;\Varid{a}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \Varid{show}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{60}{}\<[60]%
\>[60]{}\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{60}{}\<[60]%
\>[60]{}\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 -\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\tt \char34 SUB\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{60}{}\<[60]%
\>[60]{}\Varid{g}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Varid{unid}}{\Varid{comp}}\;\mathbf{where}\;\Varid{unid}\;(\Varid{a})\mathrel{=}\Conid{Unid}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{32}{}\<[32]%
\>[32]{}\Varid{comp}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(\Varid{b},(\Varid{c},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseL2D}\;\Varid{f}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{f}+(\Varid{g}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recL2D}\;\Varid{f}\mathrel{=}\Varid{baseL2D}\;\Varid{id}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataL2D}\mathbin{::}(\Varid{b1}+(\Varid{b2},(\Varid{d},\Varid{d}))\to \Varid{d})\to \Conid{X}\;\Varid{b1}\;\Varid{b2}\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{cataL2D}\;\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{recL2D}\;(\Varid{cataL2D}\;\Varid{g}))\comp \Varid{outL2D}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaL2D}\mathbin{::}(\Varid{a1}\to \Varid{a2}+(\Varid{b},(\Varid{a1},\Varid{a1})))\to \Varid{a1}\to \Conid{X}\;\Varid{a2}\;\Varid{b}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calcOrigins}\mathbin{::}(\Conid{L2D},\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\mathrel{=}\Varid{anaL2D}\;((\Varid{id}+\conj{\mathbin{!}}{\Varid{calcOrigins\char95 abs}})\comp \Varid{distl}\comp (\Varid{outL2D}\times\Varid{id})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{30}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dimen1}\mathbin{::}\Conid{Caixa}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen1}\;((\Varid{x},\Varid{y}),(\anonymous ,\anonymous ))\mathrel{=}(\Varid{fromIntegral}\;\Varid{x},\Varid{fromIntegral}\;\Varid{y}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen2}\mathbin{::}(\Conid{Tipo},((\Conid{Float},\Conid{Float}),(\Conid{Float},\Conid{Float})))\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen2}\;(\Varid{t},((e_1 ,e_2 ),(\Varid{d1},\Varid{d2})))\mid \Varid{elem}\;\Varid{t}\;[\mskip1.5mu \Conid{H},\Conid{Hb},\Conid{Ht}\mskip1.5mu]\mathrel{=}(e_1 \mathbin{+}\Varid{d1},\Varid{max}\;e_2 \;\Varid{d2}){}\<[E]%
\\
\>[B]{}\hsindent{30}{}\<[30]%
\>[30]{}\mid \Varid{elem}\;\Varid{t}\;[\mskip1.5mu \Conid{V},\Conid{Ve},\Conid{Vd}\mskip1.5mu]\mathrel{=}(\Varid{max}\;e_1 \;\Varid{d1},e_2 \mathbin{+}\Varid{d2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen}\mathbin{::}\Conid{L2D}\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{dimen1}}{\Varid{dimen2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins\char95 abs}\mathbin{::}((\Conid{Tipo},(\Conid{L2D},\Conid{L2D})),\Conid{Origem})\to ((\Conid{L2D},\Conid{Origem}),(\Conid{L2D},\Conid{Origem})){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{H},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox}\mathbin{+}\Varid{difx},\Varid{oy}\mathbin{-}\Varid{dify}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{difx}\mathrel{=}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{dify}\mathrel{=}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{d})\mathbin{/}\mathrm{2}\mathbin{-}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{e})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{Hb},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox}\mathbin{+}\Varid{difx},\Varid{oy}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{difx}\mathrel{=}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{Ht},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox}\mathbin{+}\Varid{difx},\Varid{oy}\mathbin{-}\Varid{dify}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{difx}\mathrel{=}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{dify}\mathrel{=}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{d})\mathbin{-}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{V},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox}\mathbin{-}\Varid{difx},\Varid{oy}\mathbin{+}\Varid{dify}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{difx}\mathrel{=}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{d})\mathbin{/}\mathrm{2}\mathbin{-}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{e})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{dify}\mathrel{=}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{Ve},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox},\Varid{oy}\mathbin{+}\Varid{dify}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{dify}\mathrel{=}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins\char95 abs}\;((\Conid{Vd},(\Varid{e},\Varid{d})),(\Varid{ox},\Varid{oy}))\mathrel{=}((\Varid{e},(\Varid{ox},\Varid{oy})),(\Varid{d},(\Varid{ox}\mathbin{-}\Varid{difx},\Varid{oy}\mathbin{+}\Varid{dify}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{difx}\mathrel{=}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{d})\mathbin{-}(\p1\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{dify}\mathrel{=}(\p2\mathbin{\$}\Varid{dimen}\;\Varid{e}){}\<[E]%
\ColumnHook
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to [\mskip1.5mu (\Conid{Origem},\Conid{Caixa})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{singl}\comp \Varid{swap}}{\mathsf{conc}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{}
           \ar[d]_-{cataL2D (g)}
&
    \ensuremath{\Conid{CAIXA}\mathbin{+}\Conid{TIPO}\mathbin{\uparrow}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{f}\times(\Varid{g}\times\Varid{g})}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{desenha\char95 caixa}\mathbin{::}(\Conid{Origem},\Conid{Caixa})\to \Conid{\Conid{G}.Picture}{}\<[E]%
\\
\>[B]{}\Varid{desenha\char95 caixa}\;(\Varid{o},((\Varid{l},\Varid{a}),(\Varid{t},\Varid{c})))\mathrel{=}\Varid{crCaixa}\;\Varid{o}\;(\Varid{fromIntegral}\;\Varid{l})\;(\Varid{fromIntegral}\;\Varid{a})\;\Varid{t}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mostra\char95 caixas}\mathbin{::}(\Conid{L2D},\Conid{Origem})\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{mostra\char95 caixas}\mathrel{=}\Varid{display}\comp \Varid{\Conid{G}.pictures}\comp (\map \;\Varid{desenha\char95 caixa})\comp \Varid{agrup\char95 caixas}\comp \Varid{calcOrigins}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Varid{\Conid{G}.pictures}\comp (\map \;\Varid{desenha\char95 caixa})\comp \Varid{agrup\char95 caixas}\comp \Varid{calcOrigins}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},(\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{3}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{c},\Varid{h},\Varid{s})\mathrel{=}(\Varid{c}\mathbin{+}\Varid{h},(\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}(\Varid{s}\mathbin{*}(\Varid{s}\mathbin{+}\mathrm{1}))\mathbin{*}\Varid{h},\Varid{s}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{c},\Varid{h},\Varid{s})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;(\Conid{FS}\;\Varid{l}))\mathrel{=}i_2\;(\Conid{FS}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3cm{
    ...
    \ar[d]_-{\ensuremath{\Varid{cata}\;\Varid{g}}}
    \ar@/^1pc/[r]^{\ensuremath{\Varid{outFS}}}
    \ar@{}[r]|-{\cong}
&
    \ensuremath{(\Conid{A}\times(\Conid{File}\mathbin{+}\Conid{Dir})))} 
    \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}(\Varid{cata}\;\Varid{g})))}}
    \ar@/^1pc/[l]^{\ensuremath{\Varid{inFS}}}
\\
     \ensuremath{\Conid{T}} 
& \ensuremath{(\Conid{A}\times(\Conid{File}\times\Conid{T}))} 
    \ar[l]^-{g}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\Varid{nr}\comp \map \;\p1}{\Varid{and}\comp \Varid{rights}\comp (\mathsf{fmap}\;\p2)}){}\<[E]%
\\[\blanklineskip]%
